...
describe("GET My Contributions", function () {
    before(function() {
        ...
        db.serialize(function() {
            ...
            db.serialize(function(){
                ...
                db.run("INSERT INTO campaign_contributor (campaignId, userId, contribution) VALUES ($campaignId, $userId, $contribution)",
                    testData.campaignContributors[0]);
            });
        });
    });
    ...
    it("should return the mock data", function () {
        return request
            .get('/api/myContributions?userId=1')
            .then((res) => {
